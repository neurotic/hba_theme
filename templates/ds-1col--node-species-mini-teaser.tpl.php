<div class="left">
  ...
  <?php
    ...
    print '<div class="ds-taxonomy"><span class="label"><strong>Taxonomy:</strong> </span> <span class="name_desc">' . render($content['field_sp_name_desc'][0]) . '</span> <span class="descriptor">' . render($content['field_sp_descriptor'][0]) . '</span>, <span class="year">' . render($content['field_sp_year'][0]) . '</span>, <span class="type_locality">' . render($content['field_sp_type_locality'][0]) . '</span>.';
